...
- [x] Graphics documentation (all graph types, plot features, inference)
- [x] Graphics documentation review (13 questions resolved)
- [x] Lite panel docs cross-reference and migration
- [x] Sparse reference page expansion (collapse, rename, combine, rank, standardise, etc.)
- [x] Dataset Menu (Data Dictionary, Generate Report, Reorder/Select)
- [x] Variables Menu (Convert to Categorical batch)
- [x] Interactive Plots (Desktop/Lite)
- [x] More Plot Types (ggplot2)
- [x] Menubar reference documentation
- [x] Model Fitting Code History
- [x] Transform page Desktop/Lite variants
- [x] Create Variables Lite calculator UI
- [x] Form Class Intervals expansion
- [x] Identify Points Lite range method
...
- Survey data uses Pearson correlation (not Spearman) — document in survey section
