...
Go to **Advanced** → **Time Series** from the menu bar.

</Desktop>

<Lite>

Select **Time Series** from the module dropdown menu at the top of the sidebar.
...
If your data contains multiple time series (e.g., sales data for different regions), select the identifying variable(s) as **Keys**. <Lite>Use CTRL+click (or CMD+click on Mac) to select multiple key variables.</Lite> This allows iNZight to:
...
Choose the plot type using the radio buttons in the **Plot type** section of the sidebar.
