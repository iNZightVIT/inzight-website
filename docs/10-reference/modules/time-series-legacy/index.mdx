...
:::info
This is the **legacy** Time Series module. For new projects, we recommend using the [new Time Series module](/docs/reference/modules/time-series), which uses modern tidyverts packages and provides better support for complex time series data.
:::
