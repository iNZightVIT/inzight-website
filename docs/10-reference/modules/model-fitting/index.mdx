...
This documentation was generated based on help files and source code. Items to verify:
- Exact UI controls (drag-and-drop, double-click, right-click menus)
- Available model frameworks and transformations
- Diagnostic plot options
- Desktop vs Lite differences
:::
...
Go to **Advanced** → **Model Fitting** from the menu bar.
