...
import ctrlPanel from "./control-panel.png"

<Figure src={ctrlPanel} caption="iNZight Control Panel" width={400} />
...
:::info Other variable controls

**Switch**: The down arrow allows you to quickly swith the variable on that row with the one below it.

**Clear**: The cross to the right of each drop-down clears that variable.
