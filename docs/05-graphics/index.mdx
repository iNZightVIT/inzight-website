...
Additionally, iNZight provides a range of [alternative plot types built with ggplot2](/docs/graphics/graph-types/ggplot2), including boxplots, violin plots, beeswarm plots, pie charts, heatmaps, and more.
