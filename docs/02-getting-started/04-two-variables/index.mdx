---
title: Working with two variables
description: Plots and summaries for pairs of variables - the "Variable 2" box
---
...
<Figure src={{ desktop: bp1, lite: bp1l }} caption="A plot of travel by gender" width="800" />
