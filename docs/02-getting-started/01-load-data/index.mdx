...
<desktop>
  <Figure src={loadDataImg} caption="iNZight import data window" width="600" />
</desktop>
<lite>
  <Figure src={loadDataImgL} caption="iNZight import data window" width="600" />
</lite>
...
<desktop>
  <Figure src={exampleDataImg} caption="Load example data into iNZight" />
</desktop>
<lite>
  <Figure src={exampleDataImgL} caption="Load example data into iNZight" />
</lite>
