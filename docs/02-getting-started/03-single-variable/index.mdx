...
<Figure src={f2} caption="Numeric summary of armspan" width="600" />;
...
import f4 from "../02-first-graphs/inzight_cas_travel.png";
...
<Figure src={smryTravel} caption="Numeric summary of travel" width="600" />
