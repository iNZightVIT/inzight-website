...
Once again, we will be working with the **Census at School 500** example data set we loaded in [First Graphs](load-data).
...
import ss1 from "./inzight_cas_height_armspan_subset_age_gender.png";

<Figure
  src={ss1}
  caption="A plot of height versus armspan subset by age, and filtered by gender."
  width="800"
/>
...
import ss2 from "./inzight_cas_height_armspan_subset_age_gender-female.png";

<Figure
  src={ss2}
  caption="A plot of height versus armspan subset by age, and filtered by gender = female."
  width="800"
/>
